...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin', 'prevent-back-history']], function () {
    ...
    Route::controller(AdminController::class)->group(function () {
        ...
        Route::post('clear-homecache', 'clearHomePageCache')->name('homecache.clear');
    ...
    Route::get('success-stories/destroy/{id}', [SuccessStoryController::class, 'destroy'])->name('success-stories.destroy');
