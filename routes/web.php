...
Route::controller(HomeController::class)->group(function () {
    ...
    //Home Page
    Route::get('/', 'indexWithFullPageCache')->name('home');
    Route::get('all-success-stories', 'allSuccessStories')->name('all_sucess_stories');
...
Route::controller(BlogController::class)->group(function () {
    Route::get('/blog', action: 'all_blog')->name('blog');
...
Route::controller(ContactController::class)->group(function () {
    Route::post('/contact', 'contact')->name('contact')->middleware('throttle:2,1'); // max 2 submissions per minute per IP;
});
