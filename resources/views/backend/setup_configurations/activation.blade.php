...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6 text-center">{{ translate('Cart Activation') }}</h5>

                </div>
                <div class="card-body text-center">
                    <label class="aiz-switch aiz-switch-success mb-0">
                        <input type="checkbox" onchange="updateSettings(this, 'enable_product_ask_for_price')"
                            <?php if (get_setting('enable_product_ask_for_price') == 1) {
                                echo 'checked';
                            } ?>>
                    ...
                    <div class="alert"
                        ...
                        {{ translate('Hide Product Pricing & Add to Cart Button') }}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header">
                    <h3 class="mb-0 h6 text-center">{{ translate('Success Stories Activation?') }}</h3>
                </div>
                <div class="card-body text-center">
                    <label class="aiz-switch aiz-switch-success mb-0">
                        <input type="checkbox" onchange="updateSettings(this, 'success_stories')" <?php if (get_setting('success_stories') == 1) {
                            echo 'checked';
                        } ?>>
                        <span class="slider round"></span>
                    </label>
