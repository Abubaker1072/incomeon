...
<div class="page-content">
    ...
    <div class="d-sm-flex">
                ...
                <div class="tab-content">
                        ...
                        <div class="bg-white p-3 p-sm-2rem">
                            ...
                            <div class="w-100">
                                <div class="row">
                                    <div class="col-xxl-7 col-xl-6">
                                        ...
                                        <div class="form-group row">
                                           ...
                                           <div class="col-xxl-9">
                                               <input type="text" class="form-control" name="model_number" placeholder="e.g 23323232">
                                           </div>
                                        </div>
                                        <!-- Weight -->
                                        <div class="form-group row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <textarea class="" id="summernote" name="description">{{ old('description') }}</textarea>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane fade" id="files_and_media" role="tabpanel" aria-labelledby="files-and-media-tab">
                        <div class="bg-white p-3 p-sm-2rem">
                            ...
                            <div class="form-group row d-none">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control aiz-selectpicker" name="video_provider" id="video_provider">
                                        <option value="local" @selected(old('video_provider') == 'local')>{{translate('Local')}}</option>
                            ...
                            <!-- Video Link -->
                            <div class="form-group row d-none">
                                <label class="col-md-3 col-from-label">{{translate('Useful Links')}}</label>
                                <div class="col-md-9">
                            ...
                            <!-- PDF Specifications (for multiple files, JSON storage) -->
                            <div class="form-group row">
        ...
        <div class="input-group" data-toggle="aizuploader" data-type="document" data-multiple="true">
            ...
            <input type="hidden" name="pdf_ids" class="selected-files">
        </div>
    ...
    <div class="col-md-9">
        ...
        <div class="input-group" data-toggle="aizuploader" data-type="document">
            ...
            <input type="hidden" name="ies_id" value="" class="selected-files">
        </div>
        <div class="file-preview box sm"></div>
    </div>
</div>
...
<script>
    let linkIndex = 1; // Start from 1, as the first element is already present with index 0.
    ...
    // Show the 'Remove' button for the first input if a link is present.
    // This is optional, but a good UX enhancement.
    // If you are loading existing data, you'd handle that here.
...
<script>
    let specIndex = 1; // Start from 1, as the first element is already present with index 0.
...
<script>
    ...
    setInterval(updateTitleInputs, 200); // Check every 200 milliseconds
</script>
