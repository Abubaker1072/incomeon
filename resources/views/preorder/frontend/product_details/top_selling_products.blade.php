                ...
                <li class="py-3 px-0 list-group-item border-0">
                    <div class="row gutters-10 align-items-center hov-scale-img hov-shadow-md overflow-hidden has-transition">
                        ...
                        <div class="col text-left">
                            ...
                            <div class="">
                                <!-- Price -->
                                <span class="fs-14 fw-700 text-primary {{ get_setting('enable_product_ask_for_price') == 1 ? 'd-none':'' }}">{{ home_discounted_base_price($top_product) }}</span>
                                <!-- Home Price -->
                                @if(home_price($top_product) != home_discounted_price($top_product))
                                <del class="fs-14 fw-700 opacity-60 ml-1 ml-lg-0 ml-xl-1 {{ get_setting('enable_product_ask_for_price') == 1 ? 'd-none':'' }}">
