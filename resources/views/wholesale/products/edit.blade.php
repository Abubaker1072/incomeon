            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row d-none" id="videoLink">
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="false">
                                        ...
                                        <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                        <input type="hidden" name="video_thumbnail" class="selected-files" value="{{$product->video_thumbnail_id}}">
                                    </div>
                                    <div class="file-preview box sm">
                                    </div>
                                    
                                    <small class="text-muted">{{translate('This image is visible in all product page.')}}</small>
                                </div>
                            </div>
                        <div class="form-group row" id="localVideo">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group" data-toggle="aizuploader" data-type="video" data-multiple="false">
                                        ...
                                        <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                        <input type="hidden" name="local_video_id" class="selected-files" value="{{$product->local_video_id}}">
                                    </div>
                                    <div class="file-preview box sm">
                                    </div>
