                                        ...
                                        @if ($flash_deal_product->product != null && $flash_deal_product->product->published != 0)
                                            ...
                                            <div
                                                ...
                                                <a href="{{ $product_url }}"
                                                    ...
                                                    <!-- Price -->
                                                    <h4 class="disc-amount has-transition {{ get_setting('enable_product_ask_for_price') == 1 ? 'd-none':'' }}">
                                                        @if ($flash_deal_product->auction_product == 0)
                                                            ...
                                                            @if (home_base_price($flash_deal_product->product) != home_discounted_base_price($flash_deal_product->product))
                                                                <span class="disc-amount has-transition">
                                                                    <del class="fw-400 text-secondary mr-1 {{ get_setting('enable_product_ask_for_price') == 1 ? 'd-none':'' }}">{{ home_base_price($flash_deal_product->product) }}</del>
                                                                </span>
                                                            @endif
                                                            <!-- price -->
