...
@section('content')
                                    ...
                                    @if ($flash_deal_product->product != null && $flash_deal_product->product->published != 0)
                                        ...
                                        <div
                                            ...
                                            <a href="{{ $product_url }}"
                                                ...
                                                <!-- Price -->
                                                <div
                                                    class="fs-10 fs-md-14 mt-md-3 text-center h-md-48px has-transition overflow-hidden pt-md-4 flash-deal-price lh-1-5 {{ get_setting('enable_product_ask_for_price') == 1 ? 'd-none' : '' }}">
                                                    <span
                                        ...
                                        <div class="row hov-scale-img">
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="fs-14 mb-3">
                                                    ...
                                                    <span
                                                        class="fw-700 text-primary {{ get_setting('enable_product_ask_for_price') == 1 ? 'd-none' : '' }}">{{ single_price($classified_product->unit_price) }}</span>
                                                </div>
    ...
    @if (get_setting('success_stories') == 1)
        <section class="gallery-section mb-5 mt-1">
            <div class="container">
                <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between">
                    <!-- Title -->
                    <h3 class="fs-16 fs-md-20 fw-700 mb-2 mb-sm-0">
                        <span class="pb-3">{{ translate('Our Successfull Stories ') }}</span>
                    </h3>
                    <!-- Links -->
                    <div class="d-flex">
                        <a class="text-blue fs-10 fs-md-12 fw-700 hov-text-primary animate-underline-primary"
                            href="{{ route('all_sucess_stories') }}">{{ translate('View All') }}</a>
                    </div>
                </div>
                <div class="row row-cols-2 row-cols-md-4 border-top border-left">
                    @foreach ($success_stories as $key => $highlight)
                        @if ($key < 8)
                            <div class="col text-center border-right border-bottom z-1">
                                <div class="gallery-item">
                                    {{-- REMOVED unnecessary d-block class if causing layout issues, though usually fine --}}
                                    <a href="#">
                                        <div class="image-container">
                                            ...
                                            {{-- **THIS IS THE CRITICAL PART:** The text is correctly placed and styled for centering/hover --}}
