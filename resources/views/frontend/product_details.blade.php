...
@section('script')
    ...
    <script>
    $('#videoPlayModal').on('show.bs.modal', function (event) {
        var button = $(event.relatedTarget);
        var videoUrl = button.data('video-url');
        var videoTitle = button.data('video-title');
        var modal = $(this);
        var youtubePlayer = modal.find('#youtube-player');
        ...
        if (videoUrl && (videoUrl.includes('youtube.com') || videoUrl.includes('youtu.be'))) {
            ...
            if (videoId) {
                youtubePlayer.attr('src', `https://www.youtube.com/embed/${videoId}?autoplay=1&rel=0`);
            } else {
    ...
    $('#videoPlayModal').on('hide.bs.modal', function () {
        var youtubePlayer = $(this).find('#youtube-player');
        youtubePlayer.attr('src', '');
    });
</script>
@endsection
