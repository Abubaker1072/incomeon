                                    ...
                                    <div class="carousel-box">
                                        <div class="aiz-card-box hov-shadow-md my-2 has-transition hov-scale-img">
                                            ...
                                            <div class="p-md-3 p-2 text-center">
                                                ...
                                                <div class="fs-14 mt-3 {{ get_setting('enable_product_ask_for_price') == 1 ? 'd-none':'' }}">
                                                    <span class="fw-700 text-primary {{ get_setting('enable_product_ask_for_price') == 1 ? 'd-none':'' }}">{{ home_discounted_base_price($related_product) }}</span>
