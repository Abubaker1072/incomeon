                                ...
                                @foreach (Session::get('compare') as $key => $item)
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6 py-3">
                                        <div class="border">
                                            ...
                                            <!-- Price -->
                                            <div class="p-4 border-bottom {{ get_setting('enable_product_ask_for_price') == 1 ? 'd-none':'' }}">
                                                <span class="fs-12 text-gray {{ get_setting('enable_product_ask_for_price') == 1 ? 'd-none':'' }}">{{ translate('Price')}}</span>
                                                <h5 class="mb-0 fs-14 mt-1 {{ get_setting('enable_product_ask_for_price') == 1 ? 'd-none':'' }}">
                                            ...
                                            <!-- Add to cart -->
                                            <div class="p-4">
                                                <button type="button" class="btn btn-block btn-dark rounded-0 fs-13 fw-700 has-transition opacity-80 hov-opacity-100 {{ get_setting('enable_product_ask_for_price') == 1 ? 'd-none':'' }}">
