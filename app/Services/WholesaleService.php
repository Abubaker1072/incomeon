...
class WholesaleService
{
    ...
    public function update(Request $request, $id)
    {
        ...
        // Local Video Update 
        if ($request['video_provider'] == 'local' && !empty($request['local_video_id'])) {
            $upload  = Upload::find($request['local_video_id']);
            $product->video_link = $upload->file_name;
        }

        if (!empty($request['video_thumbnail'])) {
            $upload  = Upload::find($request['video_thumbnail']);
            $product->video_thumbnail = $upload->file_name;
        }
