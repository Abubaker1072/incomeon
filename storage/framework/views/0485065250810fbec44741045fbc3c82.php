    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <!-- Product -->
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['add_new_product', 'show_all_products', 'show_in_house_products', 'show_seller_products',
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show_seller_products')): ?>
                                    <li class="aiz-side-nav-item">
                                        ...
                                        <ul class="aiz-side-nav-list level-3">
                                            <li class="aiz-side-nav-item">
                                                <a href="<?php echo e(route('products.seller', 'physical')); ?>"
                                                    class="aiz-side-nav-link">
                                                    <span
                                                        class="aiz-side-nav-text"><?php echo e(translate('Physical Products')); ?></span>
                                                </a>
                                            </li>
                                            <li class="aiz-side-nav-item">
                                                <a href="<?php echo e(route('products.seller', 'digital')); ?>"
                                                    class="aiz-side-nav-link">
                                                    <span class="aiz-side-nav-text"><?php echo e(translate('Digital Products')); ?></span>
                                                </a>
                                            </li>
                                ...
                                <li class="aiz-side-nav-item">
                                    ...
                                    <ul class="aiz-side-nav-list level-3">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_size_charts')): ?>
                                            <li class="aiz-side-nav-item">
                                                <a href="<?php echo e(route('size-charts.index')); ?>"
                                                    class="aiz-side-nav-link <?php echo e(areActiveRoutes(['size-charts.index', 'size-charts.create', 'size-charts.edit'])); ?>">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_product_warranties')): ?>
                                <li class="aiz-side-nav-item">
                                    <a href="<?php echo e(route('warranties.index')); ?>"
                                        class="aiz-side-nav-link <?php echo e(areActiveRoutes(['warranties.edit'])); ?>">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_product_reviews')): ?>
                                <li class="aiz-side-nav-item">
                                    <a href="<?php echo e(route('reviews.index')); ?>"
                                        class="aiz-side-nav-link <?php echo e(areActiveRoutes(['detail-reviews', 'custom-review.edit'])); ?>">
                ...
                <?php if(addon_is_activated('preorder')): ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['preorder_dashboard', 'add_preorder_product', 'view_all_preorder_products',
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add_preorder_product')): ?>
                                    <li class="aiz-side-nav-item">
                                        <a href="<?php echo e(route('preorder-product.create')); ?>" class="aiz-side-nav-link">
                                            <span
                                                class="aiz-side-nav-text"><?php echo e(translate('Add New Preorder products')); ?></span>
                                        </a>
                                    </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_all_preorder_products')): ?>
                                    <li class="aiz-side-nav-item">
                                        <a href="<?php echo e(route('preorder-product.index')); ?>"
                                            class="aiz-side-nav-link <?php echo e(areActiveRoutes(['preorder-product.edit'])); ?>">
                                            <span class="aiz-side-nav-text"><?php echo e(translate('Preorder Products')); ?></span>
                                        </a>
                                    </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['view_all_preorders', 'view_all_inhouse_preorders', 'view_all_seller_preorders',
                                    'view_all_delayed_prepayment_preorders', 'view_all_final_preorders'])): ?>
                                    <li class="aiz-side-nav-item">
                                        <a href="javascript:void(0);" class="aiz-side-nav-link">
                                        ...
                                        <ul class="aiz-side-nav-list level-3">
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_all_preorders')): ?>
                                                <li class="aiz-side-nav-item">
                                                    <a href="<?php echo e(route('all_preorder.list')); ?>"
                                                        class="aiz-side-nav-link <?php echo e(areActiveRoutes(['preorder-order.show'])); ?> }}">
                                                        <span class="aiz-side-nav-text"><?php echo e(translate('All Orders')); ?> <span
                                                                class="badge badge-info ml-1"><?php echo e($all_preorders_count ?: ''); ?></span>
                                                        </span>
                                                    </a>
                                                </li>
                                            <?php endif; ?>
                                                ...
                                                <li class="aiz-side-nav-item">
                                                    <a href="<?php echo e(route('inhouse_preorder.list')); ?>" class="aiz-side-nav-link">
                                                        <span class="aiz-side-nav-text"><?php echo e(translate('Inhouse Orders')); ?> <span
                                                                class="badge badge-info ml-1"><?php echo e($inhouse_preorders_count ?: ''); ?></span></span>
                                                    </a>
                                                </li>
                                            <?php endif; ?>
                                                ...
                                                <li class="aiz-side-nav-item">
                                                    <a href="<?php echo e(route('seller_preorder.list')); ?>" class="aiz-side-nav-link">
                                                        <span class="aiz-side-nav-text"><?php echo e(translate('Seller Orders')); ?> <span
                                                                class="badge badge-info ml-1"><?php echo e($sellers_preorders_count ?: ''); ?></span></span>
                                                    </a>
                                                </li>
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_all_delayed_prepayment_preorders')): ?>
                                                <li class="aiz-side-nav-item">
                                                    <a href="<?php echo e(route('delayed_prepayment_preorders.list')); ?>"
                                                        class="aiz-side-nav-link">
                                                        <span class="aiz-side-nav-text"><?php echo e(translate('Delayed Prepayment')); ?>

                                                            <span
                                                                class="badge badge-info ml-1"><?php echo e($delayed_prepayment_preorders_count ?: ''); ?></span></span>
                                                    </a>
                                                </li>
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_all_final_preorders')): ?>
                                                <li class="aiz-side-nav-item">
                                                    <a href="<?php echo e(route('delayed_final_orders.list')); ?>" class="aiz-side-nav-link">
                                                        <span class="aiz-side-nav-text"><?php echo e(translate('Delayed Final Orders')); ?>

                                                            <span
                                                                class="badge badge-info ml-1"><?php echo e($delayed_final_orders_count ?: ''); ?></span></span>
                                                    </a>
                                                </li>
                                            <?php endif; ?>
                                        </ul>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_preorder_seller_commission_history')): ?>
                                    <li class="aiz-side-nav-item">
                                        <a href="<?php echo e(route('preorder-commission-history')); ?>" class="aiz-side-nav-link">
                                            <span
                                                class="aiz-side-nav-text"><?php echo e(translate('Preorder Commission History')); ?></span>
                                        </a>
                                    </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('preorder_settings')): ?>
                                    <li class="aiz-side-nav-item">
                                        <a href="<?php echo e(route('preorder-settings')); ?>"
                                            class="aiz-side-nav-link <?php echo e(areActiveRoutes(['faqs.create', 'faq.edit'])); ?>">
                                    ...
                                    <?php if(get_setting('conversation_system') == 1): ?>
                                        ...
                                        <li class="aiz-side-nav-item">
                                            <a href="<?php echo e(route('preorder-conversations.admin_index')); ?>"
                                                ...
                                                <span
                                                    class="aiz-side-nav-text"><?php echo e(translate('Preorder Product Conversation')); ?></span>
                                    ...
                                    <?php if(get_setting('product_query_activation') == 1): ?>
                                        <li class="aiz-side-nav-item">
                                            <a href="<?php echo e(route('preorder.product_query.index')); ?>"
                                                ...
                                                <span
                                                    class="aiz-side-nav-text"><?php echo e(translate('Preorder Product Queries')); ?></span>
                                            </a>
                                        </li>
                                    <?php endif; ?>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_all_preorder_product_reviews')): ?>
                                    <li class="aiz-side-nav-item">
                                        <a href="<?php echo e(route('preorder.product_reviews.index')); ?>"
                                            ...
                                            <span
                                                class="aiz-side-nav-text"><?php echo e(translate('Preorder Product Reviews')); ?></span>
                                        </a>
                                    </li>
                                <?php endif; ?>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_all_preorder_notification_types')): ?>
                                    <li class="aiz-side-nav-item">
                                        <a href="<?php echo e(route('preorder-notification-types.index')); ?>"
                                            ...
                                            <span
                                                class="aiz-side-nav-text"><?php echo e(translate('Preorder Notification Types')); ?></span>
                                        </a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                ...
                <?php if(addon_is_activated('auction')): ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['add_auction_product', 'view_all_auction_products', 'view_inhouse_auction_products',
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_inhouse_auction_products')): ?>
                                    <li class="aiz-side-nav-item">
                                        <a href="<?php echo e(route('auction.inhouse_products')); ?>" class="aiz-side-nav-link">
                                            <span
                                                class="aiz-side-nav-text"><?php echo e(translate('Inhouse Auction Products')); ?></span>
                                        </a>
                                    </li>
                                <?php endif; ?>
                                <?php if(get_setting('vendor_system_activation') == 1): ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_seller_auction_products')): ?>
                                        <li class="aiz-side-nav-item">
                                            <a href="<?php echo e(route('auction.seller_products')); ?>" class="aiz-side-nav-link">
                                                <span
                                                    class="aiz-side-nav-text"><?php echo e(translate('Seller Auction Products')); ?></span>
                                            </a>
                                        </li>
                                    <?php endif; ?>
                                <?php endif; ?>
                ...
                <?php if(addon_is_activated('wholesale')): ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['add_wholesale_product', 'view_all_wholesale_products', 'view_inhouse_wholesale_products',
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add_wholesale_product')): ?>
                                    <li class="aiz-side-nav-item">
                                        <a class="aiz-side-nav-link" href="<?php echo e(route('wholesale_product_create.admin')); ?>">
                                            <span
                                                class="aiz-side-nav-text"><?php echo e(translate('Add New Wholesale Product')); ?></span>
                                        </a>
                                    </li>
                                <?php endif; ?>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_inhouse_wholesale_products')): ?>
                                    <li class="aiz-side-nav-item">
                                        <a href="<?php echo e(route('wholesale_products.in_house')); ?>"
                                            class="aiz-side-nav-link <?php echo e(areActiveRoutes(['wholesale_product_edit.admin'])); ?>">
                                            <span
                                                class="aiz-side-nav-text"><?php echo e(translate('In House Wholesale Products')); ?></span>
                                        </a>
                                    </li>
                                <?php endif; ?>
                                <?php if(get_setting('vendor_system_activation') == 1): ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_sellers_wholesale_products')): ?>
                                        <li class="aiz-side-nav-item">
                                            <a href="<?php echo e(route('wholesale_products.seller')); ?>"
                                                class="aiz-side-nav-link <?php echo e(areActiveRoutes(['wholesale_product_edit.admin'])); ?>">
                                                <span
                                                    class="aiz-side-nav-text"><?php echo e(translate('Seller Wholesale Products')); ?></span>
                                            </a>
                                        </li>
                                    <?php endif; ?>
                                <?php endif; ?>
                ...
                <?php if(addon_is_activated('delivery_boy')): ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['view_all_delivery_boy', 'add_delivery_boy', 'delivery_boy_payment_history',
                        ...
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('collected_histories_from_delivery_boy')): ?>
                                    <li class="aiz-side-nav-item">
                                        <a href="<?php echo e(route('delivery-boys-collection-histories')); ?>"
                                            class="aiz-side-nav-link">
                ...
                <?php if(addon_is_activated('refund_request')): ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['view_refund_requests', 'view_approved_refund_requests', 'view_rejected_refund_requests',
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_refund_requests')): ?>
                                    <li class="aiz-side-nav-item">
                                        <a href="<?php echo e(route('refund_requests_all')); ?>"
                                            class="aiz-side-nav-link <?php echo e(areActiveRoutes(['refund_requests_all', 'admin.reason_show'])); ?>">
                ...
                <!-- Sellers -->
                <?php if(get_setting('vendor_system_activation') == 1): ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['view_all_seller', 'seller_payment_history', 'view_seller_payout_requests',
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_all_seller')): ?>
                                    <li class="aiz-side-nav-item">
                                        ...
                                        <a href="<?php echo e(route('sellers.index')); ?>"
                                            ...
                                            <?php if($sellers > 0): ?><span
                                                    class="badge badge-info"><?php echo e($sellers); ?></span> <?php endif; ?>
                                        </a>
                                    </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_all_seller_rating_and_followers')): ?>
                                    <li class="aiz-side-nav-item">
                                        <a href="<?php echo e(route('sellers.rating_followers')); ?>" class="aiz-side-nav-link">
                                            <span
                                                class="aiz-side-nav-text"><?php echo e(translate('Seller Rating & Followers')); ?></span>
                                        </a>
                                    </li>
                                <?php endif; ?>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('set_category_wise_commission')): ?>
                                    <li class="aiz-side-nav-item">
                                        <a href="<?php echo e(route('categories_wise_commission')); ?>" class="aiz-side-nav-link">
                                            <span
                                                class="aiz-side-nav-text"><?php echo e(translate('Category Based Commission')); ?></span>
                                        </a>
                                    </li>
                                <?php endif; ?>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('seller_verification_form_configuration')): ?>
                                    <li class="aiz-side-nav-item">
                                        <a href="<?php echo e(route('seller_verification_form.index')); ?>" class="aiz-side-nav-link">
                                            <span
                                                class="aiz-side-nav-text"><?php echo e(translate('Seller Verification Form')); ?></span>
                                        </a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                ...
                <li class="aiz-side-nav-item">
                    <a href="<?php echo e(route('success-stories.index')); ?>"
                        class="aiz-side-nav-link <?php echo e(areActiveRoutes(['success-stories.index', 'success-stories.create', 'success-stories.edit'])); ?>">
                        <div class="aiz-side-nav-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                viewBox="0 0 16 16">
                                <path
                                    d="M8 1C5.791 1 4 2.791 4 4C4 4.863 4.352 5.641 4.927 6.057L7.273 8.243L6.267 12.879C6.257 13.065 6.33 13.244 6.47 13.365C6.61 13.485 6.792 13.537 6.972 13.513C7.171 13.487 7.336 13.348 7.383 13.153L8 9.96L8.617 13.153C8.664 13.348 8.829 13.487 9.028 13.513C9.208 13.537 9.39 13.485 9.53 13.365C9.67 13.244 9.743 13.065 9.733 12.879L8.727 8.243L11.073 6.057C11.648 5.641 12 4.863 12 4C12 2.791 10.209 1 8 1ZM7 4C7 3.448 7.448 3 8 3C8.552 3 9 3.448 9 4C9 4.552 8.552 5 8 5C7.448 5 7 4.552 7 4Z"
                                    fill="#575b6a" />
                            </svg>

                        </div>
                        <span class="aiz-side-nav-text"><?php echo e(translate('Success Stories ')); ?></span>
                    </a>
                </li>

                <!-- Reports -->
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['earning_report', 'in_house_product_sale_report', 'seller_products_sale_report',
                ...
                <!-- marketing -->
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['view_all_flash_deals', 'view_all_dynamic_popups', 'view_all_custom_alerts',
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage_email_templates')): ?>
                                <li class="aiz-side-nav-item">
                                    ...
                                    <ul class="aiz-side-nav-list level-3">
                                        <li class="aiz-side-nav-item">
                                            <a href="<?php echo e(route('email-templates.index', 'admin')); ?>"
                                                class="aiz-side-nav-link">
                                                <span class="aiz-side-nav-text"><?php echo e(translate('Admin Templates')); ?></span>
                                            </a>
                                        </li>
                                        <li class="aiz-side-nav-item">
                                            <a href="<?php echo e(route('email-templates.index', 'seller')); ?>"
                                                class="aiz-side-nav-link">
                            ...
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['notification_settings', 'view_all_notification_types', 'send_custom_notification',
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_custom_notification_history')): ?>
                                            <li class="aiz-side-nav-item">
                                                <a href="<?php echo e(route('custom_notification.history')); ?>" class="aiz-side-nav-link">
                                                    <span
                                                        class="aiz-side-nav-text"><?php echo e(translate('Custom Notification History')); ?></span>
                                                </a>
                                            </li>
                                        <?php endif; ?>
                                    </ul>
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_all_support_tickets')): ?>
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="<?php echo e(route('support_ticket.admin_index')); ?>"
                                        ...
                                        <?php if($support_ticket > 0): ?><span
                                                class="badge badge-info"><?php echo e($support_ticket); ?></span><?php endif; ?>
                                    </a>
                                </li>
                            <?php endif; ?>
                ...
                <?php if(addon_is_activated('affiliate_system')): ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['affiliate_registration_form_config', 'affiliate_configurations', 'view_affiliate_users',
                                ...
                                <?php if(get_setting('classified_product') == 1 && auth()->user()->can('view_all_offline_customer_package_payments')): ?>
                                    <li class="aiz-side-nav-item">
                                        <a href="<?php echo e(route('offline_customer_package_payment_request.index')); ?>"
                                            class="aiz-side-nav-link">
                                            <span
                                                class="aiz-side-nav-text"><?php echo e(translate('Offline Customer Package
                                                                                                                                                                                                                                                                                                                                    Payments')); ?></span>
                                        </a>
                                    </li>
                                <?php endif; ?>
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="<?php echo e(route('paytm.index')); ?>" class="aiz-side-nav-link">
                                    <span
                                        class="aiz-side-nav-text"><?php echo e(translate('Set Asian PG Credentials')); ?></span>
                                </a>
                            </li>
                        </ul>
                    </li>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('otp_configurations')): ?>
                                    <li class="aiz-side-nav-item">
                                        <a href="<?php echo e(route('otp.login_configuration')); ?>" class="aiz-side-nav-link">
                                            <span
                                                class="aiz-side-nav-text"><?php echo e(translate('OTP Login Configuration')); ?></span>
                                        </a>
                                    </li>
                                    <li class="aiz-side-nav-item">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['header_setup', 'footer_setup', 'view_all_website_pages', 'website_appearance',
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="#"
                            class="aiz-side-nav-link <?php echo e(areActiveRoutes(['website.footer', 'website.header'])); ?>">
                            <div class="aiz-side-nav-icon">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('authentication_layout_settings')): ?>
                                <li class="aiz-side-nav-item">
                                    <a href="<?php echo e(route('website.authentication-layout-settings')); ?>"
                                        class="aiz-side-nav-link">
                                        <span
                                            class="aiz-side-nav-text"><?php echo e(translate('Authentication Layout & Settings')); ?></span>
                                    </a>
                                </li>
                            <?php endif; ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['general_settings', 'features_activation', 'language_setup', 'currency_setup',
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('file_system_&_cache_configuration')): ?>
                                <li class="aiz-side-nav-item">
                                    <a href="<?php echo e(route('file_system.index')); ?>" class="aiz-side-nav-link">
                                        <span
                                            class="aiz-side-nav-text"><?php echo e(translate('File System & Cache
                                                                                                                                                                                                                                                                                                            Configuration')); ?></span>
                                    </a>
                                </li>
                            <?php endif; ?>
                            ...
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['analytics_tools_configuration', 'google_recaptcha_configuration',
                            ...
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['shipping_configuration', 'shipping_country_setting', 'manage_shipping_states',
...
<?php /**PATH C:\laragon\www\Incomeon_ecomm\resources\views/backend/inc/admin_sidenav.blade.php ENDPATH**/ ?>