    ...
    <div class="d-flex justify-content-between align-items-stretch flex-grow-1">
        <div class="d-flex justify-content-around align-items-center align-items-stretch">
            ...
            <div class="aiz-topbar-item mr-3">
                <div class="d-flex align-items-center">
                    <a class="btn btn-topbar has-transition btn-icon btn-circle btn-light p-0 hov-bg-primary hov-svg-white d-flex align-items-center justify-content-center"
                        href="<?php echo e(route('homecache.clear')); ?>" target="_blank" data-toggle="tooltip" data-title="<?php echo e(translate('Browse Website')); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
            ...
            <div class="aiz-topbar-item mr-3">
                <div class="d-flex align-items-center">
                    <a class="btn btn-topbar has-transition btn-icon btn-circle btn-light p-0 hov-bg-primary hov-svg-white d-flex align-items-center justify-content-center"
                        href="<?php echo e(route('cache.clear')); ?>" data-toggle="tooltip" data-title="<?php echo e(translate('Clear Homepage Cache')); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                            <path id="home_cache_clear" d="M8,1.5L15,7V14.5A1.5,1.5,0,0,1,13.5,16H2.5A1.5,1.5,0,0,1,1,14.5V7L8,1.5ZM8,3.236L2.5,7.445V14.5h11V7.445L8,3.236ZM5.5,9H6.5v1H5.5ZM7.5,9H8.5v1H7.5ZM9.5,9h1v1h-1ZM5.5,11H6.5v1H5.5ZM7.5,11H8.5v1H7.5ZM9.5,11h1v1h-1Z" fill="#717580"/>
                        </svg>
                    </a>
                </div>
            </div>
...
</div><!-- .aiz-topbar --><?php /**PATH C:\laragon\www\Incomeon_ecomm\resources\views/backend/inc/admin_nav.blade.php ENDPATH**/ ?>